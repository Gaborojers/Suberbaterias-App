...
import '../../Styles/Inventario/InventarioGeneralC.css';
...
function InventarioGeneralCascos() {
  return (
    <div className="container">
      ...
      <div className="greenRectangle">
        <h1 style={{left: '75%'}}>Inventario General de Cascos</h1>
      </div>
...
export default InventarioGeneralCascos;
