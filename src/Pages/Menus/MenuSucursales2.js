    ...
    <div className="container">
      ...
      <div className="options">
        ...
        <div className='group1' style={{left: '25%', position: 'absolute'}}>
          ...
          <Link to="./inventarioCascosLibramiento">
        ...
        <div className='group2' style={{left: '33%', position: 'absolute'}}>
          <Link to="./inventarioCascosOriente">
          ...
          <Link to="./inventarioCascosVillaflores">
...
export default MenuSucursales2;
